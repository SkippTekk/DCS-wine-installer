...
export WINEDLLOVERRIDES="wbemprox=n;dbghelp=n" # needed for the wbem to work properly (not sure why, just a thing we need)
...
export wine_path="$WINEPREFIX/runner/wine-10.19-staging-amd64/bin"
