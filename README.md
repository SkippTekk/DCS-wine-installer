...
3) `` drive_c/Program Files/Eagle Dynamics/DCS World/MissionEditor/modules/mul_voicechat.lua`` and look for **voice_chat.changeSlot(playerInfo.side, unitId)** around line 2933 (Thank you RASIS370 370 from slack)
